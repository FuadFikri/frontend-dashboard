...
import { Nilai } from '../../balanced-scorecard-setting/Model';
...
export class DataSbuComponent implements OnInit {
  ...
  refresh() {
    ...
    this.service.getCardBarByTahunDanBulanLevelSatu(this.tahunParams, this.bulanParams,this.daerah).subscribe(resp => {
      // object to array
      this.cardBars = Object.keys(resp.d).map(function (index) {
